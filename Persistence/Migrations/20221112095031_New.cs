        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userProfilesId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionProfiles", x => x.TransactionId);
                    table.ForeignKey(
                        name: "FK_TransactionProfiles_AspNetUsers_userProfilesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    USDWallet = table.Column<long>(type: "bigint", nullable: false),
                    NGNWallet = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionProfiles_userProfilesId",
